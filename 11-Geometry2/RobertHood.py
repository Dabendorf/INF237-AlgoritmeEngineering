# https://uib.kattis.com/problems/roberthood
...
""" The task is to find the maximum distance of two points in a big number of points.
	...
	- Finding the two points with maximum distance is the same as
	finding two points with maximum distance in the hull of that set
	...
	- If the inner distance for point 2 gets bigger than what we current have,
	we break that inner loop and continue with next outer point
	"""
def main():
